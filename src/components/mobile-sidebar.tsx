...
export default function MobileSidebar({ isOpen, onClose, language = 'en' }: MobileSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className="fixed top-0 right-0 bottom-0 w-80 max-w-[85vw] bg-white shadow-2xl z-50 sm:hidden transform transition-transform duration-300 ease-in-out">
