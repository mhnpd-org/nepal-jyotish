...
export default function ServiceForm({ services }: ServiceFormProps) {
  ...
  if (isSubmitted) {
    return (
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-8 text-center shadow-md" id="form">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-green-500 text-white rounded-full mb-4 shadow-lg">
          <svg
        ...
        <button
          ...
          className="px-6 py-2 bg-gradient-to-r from-rose-600 to-orange-600 text-white font-medium rounded-lg hover:from-rose-700 hover:to-orange-700 transition-all shadow-md"
        >
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden" id="form">
      {/* Form Header */}
