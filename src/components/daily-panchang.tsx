...
function PanchangContent() {
  ...
  const formatNepaliDate = (vikramSamvat: Panchanga['dates']['vikramSamvat']): string => {
    if (!vikramSamvat.monthName || !vikramSamvat.day || !vikramSamvat.year) return 'N/A';
    return `${translateSanskritSafe(vikramSamvat.monthName)} ${vikramSamvat.day}, ${vikramSamvat.year}`;
  };
  ...
  return (
    <div className="bg-white/95 backdrop-blur rounded-2xl shadow-2xl p-6 sm:p-8">
      ...
      <div className="text-center mb-6">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">आजको पञ्चाङ्ग</h2>
        <p className="text-sm text-gray-600">Daily Panchang - {panchang.location.place || 'Kathmandu, Nepal'}</p>
      </div>
      ...
      <div className="bg-gradient-to-br from-rose-50 to-orange-50 border-2 border-rose-200 rounded-xl p-6 mb-6">
        <div className="text-center">
          ...
          <div className="text-base text-gray-600">
            {translateSanskritSafe(panchang.dates.samvatsara.name)} संवत्सर • विक्रम संवत् {panchang.dates.vikramSamvat.year}
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-4">
          ...
          <p className="text-sm text-blue-700 mt-1">Nepal Standard Time (NPT)</p>
        </div>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-amber-900">
                {panchang.surya.sunrise ? formatDateNepali(panchang.surya.sunrise) : 'N/A'}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-amber-700">सूर्यास्त:</span>
              <span className="font-semibold text-amber-900">
                {panchang.surya.sunset ? formatDateNepali(panchang.surya.sunset) : 'N/A'}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-indigo-900">
                {panchang.nakshatra.moonrise ? formatDateNepali(panchang.nakshatra.moonrise) : 'N/A'}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-indigo-700">चन्द्रास्त:</span>
              <span className="font-semibold text-indigo-900">
                {panchang.nakshatra.moonset ? formatDateNepali(panchang.nakshatra.moonset) : 'N/A'}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-50 rounded-xl p-4 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="flex items-start gap-2">
            ...
            <span className="font-semibold text-gray-900">{translateSanskritSafe(panchang.tithi.tithi)}</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-gray-600">पक्ष:</span>
            <span className="font-semibold text-gray-900">{translateSanskritSafe(panchang.tithi.paksha)}</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-gray-600">नक्षत्र:</span>
            <span className="font-semibold text-gray-900">{translateSanskritSafe(panchang.nakshatra.name)} ({panchang.nakshatra.pada})</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-gray-600">योग:</span>
            <span className="font-semibold text-gray-900">{translateSanskritSafe(panchang.tithi.yoga.name)}</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-gray-600">करण:</span>
            <span className="font-semibold text-gray-900">{translateSanskritSafe(panchang.tithi.karana.name)}</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-gray-600">चन्द्र मास:</span>
            <span className="font-semibold text-gray-900">{translateSanskritSafe(panchang.tithi.chandraMasa)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 rounded-xl p-4 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="flex items-start gap-2">
            ...
            <span className="font-semibold text-teal-900">{translateSanskritSafe(panchang.surya.ritu)}</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-teal-700">अयन:</span>
            <span className="font-semibold text-teal-900">{translateSanskritSafe(panchang.surya.suryaAyana)}</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-teal-700">राशि:</span>
            <span className="font-semibold text-teal-900">{translateSanskritSafe(panchang.nakshatra.rashi)}</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-teal-700">गण:</span>
            <span className="font-semibold text-teal-900">{translateSanskritSafe(panchang.nakshatra.gana)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
        ...
        <p className="text-sm text-amber-800">
          यो पञ्चाङ्ग वैदिक ज्योतिष र सूर्य सिद्धान्तमा आधारित छ। तिथि, नक्षत्र, योग र करण प्रत्येक दिनको महत्त्वपूर्ण ज्योतिषीय तत्व हुन्।
        </p>
      </div>
    </div>
  );
