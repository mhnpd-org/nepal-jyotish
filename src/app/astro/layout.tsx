...
import { I18nProvider, useI18n } from '@internal/lib/i18n';
  ...
  return (
    <I18nProvider>
      <div className="min-h-screen flex flex-col bg-vedanga-gradient">
        <header className="h-16 flex items-center gap-4 px-5 md:px-8 bg-gradient-to-b from-amber-900/30 via-amber-900/10 to-transparent">
        ...
        <div className="flex flex-1 relative">
          <Sidebar />
          <main className="flex-1 p-4 md:p-7 bg-[rgba(255,255,250,0.82)] backdrop-blur supports-[backdrop-filter]:bg-[rgba(255,255,250,0.72)] shadow-inner">
