          ...
          return (
            <div className="flex flex-col">
              <input
                ...
                onBlur={field.onBlur}
                className="w-full px-4 py-2.5 text-base border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all cursor-pointer"
